...
par(mfrow=c(2,2)) ## 2 by 2 graphs

## 1st plot
plot(sub_HPC$DateTime,sub_HPC$Global_active_power, type="l", xlab =" ", ylab="Global Active Power")

## 2nd plot
plot(sub_HPC$DateTime,sub_HPC$Voltage, type="l", xlab ="Datetime ", ylab="Voltage")
...
## 4th plot
plot(sub_HPC$DateTime,sub_HPC$Global_reactive_power, type="l", xlab ="Datetime ", ylab="Global_reactive_power")
